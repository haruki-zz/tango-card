...
- **复习交互**：复习界面支持点击按钮、键盘快捷键（1/2/3 与方向键）以及滑动手势，方便在桌面设备或触控板上快速录入；复习时可以为单词添加/移除“不太熟悉”标签，突出薄弱词汇。
- **活跃度热力图**：主页底部提供 GitHub 风格的 Heat Map，可切换 30/60/84 天窗口，实时统计新增/复习的每日次数，填充空白区域避免大面积留黑。
