...
export function render_card_svg(input: CardTemplateInput): string {
  ...
  return [
    ...
    '.card-svg .card-bg { fill: #0f172a; }',
    '.card-svg .word { fill: #f8fafc; font-size: 52px; font-weight: 700; }',
    '.card-svg .reading { fill: #94a3b8; font-size: 28px; font-weight: 500; }',
    '.card-svg .section-title { fill: #38bdf8; letter-spacing: 0.08em; font-weight: 600; }',
    '.card-svg .section-body { fill: #e2e8f0; }',
    '</style>',
